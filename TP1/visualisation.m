...
x = randn(2,nb_indiv); 
x_mean = (1/nb_indiv)*x*ones(nb_indiv,1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure(13), clf
plot3(x(1,:),x(2,:),x(3,:),'r*','linewidth',3);grid on;hold on
plot3(x_mean(1),x_mean(2),x_mean(3),'b+','linewidth',3);grid on
